...
logging.basicConfig(
    ...
    level=logging.INFO)
InfoLogger = logging.getLogger('marketplace_logger')
...
class Marketplace:
    ...
    def __init__(self, queue_size_per_producer):
        ...
        InfoLogger.info("Init Marketplace for "
    ...
    def register_producer(self):
        ...
        InfoLogger.info("Registered producer with producer_id = %d", id_producer)
        return id_producer
    ...
    def publish(self, producer_id, product):
        ...
        if len(self.producers[producer_id]) < self.queue_size_per_producer:
            ...
            InfoLogger.info(product)
            InfoLogger.info(producer_id)
            return True
        return False
    ...
    def new_cart(self):
        ...
        InfoLogger.info("Created a new cart with the cart_id: %d", id_cart)
        return id_cart
    ...
    def place_order(self, cart_id):
        ...
        """
        InfoLogger.info(cart_id)
        InfoLogger.info(self.consumers[cart_id])
